  ...
  return (
    <>
      ...
      <div className="container about-us">
        <h2>About Us</h2>
        <p>
          Welcome to the Emplytica. Our system is designed to streamline and
          enhance the management of employees within an organization. Our goal
          is to provide an intuitive and efficient platform that helps manage
          employee data, track performance, and improve overall productivity.
        </p>
        <div className="row">
